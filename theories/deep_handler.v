...
Proof.
  rewrite /deep_handler_pre => n hanlder handler' Hhandler E h r Ψ Ψ' Φ Φ'.
...
Arguments deep_handler _ _%E _%E _%ieff _%ieff _%I _%I.
...
Proof.
  ...
  + iApply ewp_pure_step; try by apply pure_prim_step_beta. by iApply "He".
  + rewrite deep_handler_unfold.
    iSplit; [ by iDestruct "Hhandler" as "[$ _]" |].
